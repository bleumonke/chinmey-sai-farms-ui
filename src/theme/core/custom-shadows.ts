...
import { grey, info, error, commonWithChannels, primary, success, warning, secondary } from './palette';
...
function createCustomShadows(colorChannel: string): CustomShadows {
  return {
    ...
    /********/
    dialog: `-40px 40px 80px -8px ${varAlpha(commonWithChannels.blackChannel, 0.24)}`,
