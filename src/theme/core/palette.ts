...
// Create a version of common colors that includes channels, for specific utility use
export const commonWithChannels = createPaletteChannel(themeConfig.palette.common);
